<script lang="ts">
	...
	let showUnderperforming = $state(false);
...
<div class="tips-view">
	...
	{#if underperforming.length > 0}
		<div class="underperforming">
			<button class="expand-toggle" onclick={() => (showUnderperforming = !showUnderperforming)}>
				<span class="expand-label">Dragging your rank down</span>
				<span class="expand-count">{underperforming.length}</span>
				<span class="expand-chevron" class:open={showUnderperforming}>‹</span>
			</button>
